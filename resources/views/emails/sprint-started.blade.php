...
<head>
  ...
  <style>
    ...
    .header { background: #547A95; padding: 32px 40px; text-align: center; }
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <p>A new sprint has started in <strong>{{ $project->name }}</strong>.</p>
      ...
      <div class="info-box">
        ...
        @if($sprint->start_date)
          <p><strong>Start Date:</strong> {{ $sprint->start_date->format('M d, Y') }}</p>
        @endif
        @if($sprint->end_date)
