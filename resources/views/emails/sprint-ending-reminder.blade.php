...
<head>
  <meta charset="UTF-8" />
  <title>Sprint Ending Tomorrow</title>
  <style>
    ...
    .info-box { background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 20px 24px; margin: 20px 0; }
    .info-box p { margin: 0 0 8px; font-size: 14px; }
    .info-box p:last-child { margin: 0; }
    .info-box strong { color: #1e293b; }
    .btn { display: inline-block; margin-top: 20px; padding: 12px 28px; background: #f59e0b; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px; }
...
<body>
  <div class="wrapper">
    <div class="header">
      <h1>Sprint Ending Tomorrow ⚠️</h1>
    </div>
    <div class="body">
      <p>The sprint in <strong>{{ $project->name }}</strong> ends tomorrow. Make sure to wrap up any remaining work.</p>
      ...
      <div class="info-box">
        ...
        @endif
        <p><strong>End Date:</strong> {{ $sprint->end_date?->format('M d, Y') }}</p>
      </div>

      <a href="{{ config('app.url') }}" class="btn">View Sprint</a>
    </div>
    <div class="footer">
